          ...
          <button
            onClick={() => {
              const tweet = encodeURIComponent(
                `I just supported the Mob Programming Timer 🎉\n\n` +
                `A free tool for rotating drivers & pairing sessions.\n\n` +
                `👉 https://your-app.vercel.app\n` +
                `☕ https://buymeacoffee.com/mohammedovich\n` +
                `#devtools #pairprogramming #mobprogramming #opensource`
              );
            ...
            className="
              ...
              hover:underline hover:text-blue-800 dark:hover:text-blue-300
              transition
              mt-1 sm:mt-0">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
              <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.54a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 5.336v.052a3.285 3.285 0 0 0 2.632 3.218 3.202 3.202 0 0 1-1.488.055 3.283 3.283 0 0 0 3.067 2.281 6.59 6.59 0 0 1-4.087 1.404A6.761 6.761 0 0 1 0 14a9.32 9.32 0 0 0 5.026.99"/>
            </svg>
